...
import CardPh from "../components/PlaceHolders/CardPh";
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center-safe gap-[50px] pb-[50px] min-h-screen overflow-x-hidden">
      ...
      {isLoading && 
        (
          <div className="gap-8 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 grid-flow-row px-[20px] max-w-[1300px]">
      ...
      <div
        className="bg-purple-600 dark:bg-[#2563EB] px-[20px] py-[10px] rounded-2xl text-black dark:text-white"
        ref={loadRef}
      >
        {totalPages > page ? (
          isFetching ? (
