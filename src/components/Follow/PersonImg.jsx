...
export default function PersonImg(
  ...
  return (
    <div className='group'>
        ...
        <div className='-z-10 group-hover:z-10 absolute opacity-0 group-hover:opacity-100 shadow-2xl transition-all -translate-x-1/3 duration-300 ease-in-out cursor-pointer'>
